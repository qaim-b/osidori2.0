...
class TransactionModel extends TransactionEntity {
  const TransactionModel({
    ...
    super.fxRateToBase,
    super.fxBaseCurrency,
    super.baseAmountLocked,
    super.fxRateDate,
    required super.date,
  ...
  factory TransactionModel.fromJson(Map<String, dynamic> json) {
    return TransactionModel(
      ...
      fxRateToBase: (json['fx_rate_to_base'] as num?)?.toDouble(),
      fxBaseCurrency: json['fx_base_currency'] as String?,
      baseAmountLocked: (json['base_amount_locked'] as num?)?.toDouble(),
      fxRateDate: json['fx_rate_date'] == null
          ? null
          : DateTime.parse(json['fx_rate_date'] as String),
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'base_amount_locked': baseAmountLocked,
      'fx_rate_date': fxRateDate?.toIso8601String(),
  ...
  factory TransactionModel.fromEntity(TransactionEntity entity) {
    return TransactionModel(
      ...
      fxRateToBase: entity.fxRateToBase,
      fxBaseCurrency: entity.fxBaseCurrency,
      baseAmountLocked: entity.baseAmountLocked,
